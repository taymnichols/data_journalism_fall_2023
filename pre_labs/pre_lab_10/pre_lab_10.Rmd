...
This data includes zip codes and names, a length and an area of a shape, and some other information I don't really understand. Looks like it's data that describes some geometric shapes of some type.
...
Same as above - information on zip codes, zip code names, shapes and multipolygons. It's map data!
```{r}
View(md_zips)
```
...
**Answer**
It's a map of maryland :) with all the zip codes outlined which is very cool and would have been useful for many of our previous labs!
...
I successfully downloaded and installed the tigris library. There is no output.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
It's a dataset including state, county, zip, city and county names, and other data.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have all the data for each county in maryland!
...
**Task** Run the following code. Describe the output in the space below. **Answer**
It's a map of counties in Maryland (This one i can actually tell what it is and recognize the counties)
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have a very interesting looking map with zip codes AND counties outlined. It kind of looks like fractals.
```{r}
ggplot() +
...
data on the number of foreclosures by zip in March 2023.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now you can tell which areas have the most foreclosures very easily with just a quick glance.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have the population for each county!
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have a data file that includes population and the multipolygon shape data for each county.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
The two data frames have counties named differently. They also have column names with capital letters which could cause us problems if we want to use those columns but I dont think we do.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now the county names are clean and look the same!
NOTES TO SELF: str_trim removes white space on sides of data
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have population, foreclosure data, and mapping data
...
**Task** Run the following code. Describe the output in the space below. **Answer**
Now we have foreclosure data per capita
...
**Task** Run the following code. Describe the output in the space below. **Answer**
The map gives us better details about how foreclosures per capita vary by county.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
The color variation shows us much more variation between counties and the number of foreclosures.
...
Now we can see a much bigger difference in the county data.
