...
**Answer** 60712 observations, 8 variables
...
**Answer**
this sequence of code helps us look at the data by grouping it into each term to figure out how many classes are offered each term - we could also use this to group the data by seats available or professor name to find out how many classes have open seats, or how many classes a professor has taught.
...
Now the data is sorted in descending order, starting with the term that has the most classes rather than starting with the oldest term first.
...
**Answer**
We added term and department to the groupby function, which grouped the data by term and department to show us how many classes are in each department for each term
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer**
we grouped by term, then counted the number of seats available per term as well as counting the number of classes per term. We then sorted the data in descending order to show the term with the most seats first.
...
we added more math functions in the summarise section - it gave us columns with the mean and median number of seats per class per term.
...
**Answer**
We added columns for the min and max number of seats, which shows us the lowest number of seats available and the highest number of seats available
### Task 12: Questions
...
1.  Which classes saw the biggest drop in availability over time?

2.  Which classes grew the most from 2020 to 2021, 2021 to 2022, and 2022 to 2023?

3.  Which departments have the most seats available?
