...
<https://datawrapper.dwcdn.net/oorRX/1/>
...
Now instead of a giant map of the US with only color in Maryland, we have a map of Maryland with each county colored in.
...
Now the labels for each county are the county name instead of the FIPS code, and the percentage is much easier to read and actually looks like a percentage instead of a decimal with many numbers.
...
https://datawrapper.dwcdn.net/hn1XE/1/
