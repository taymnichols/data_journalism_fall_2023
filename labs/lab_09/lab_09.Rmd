...
md_gov_county_22_18 <- md_gov_county |> left_join(md_gov_county_18, by=c("county","geoid")) 
md_gov_county_22_18 <- md_gov_county_22_18 |> 
  rename(write_ins_22 = write_ins.x, write_ins18 = write_ins.y) |>
  mutate(total_22 = cox + moore + lashar + wallace + harding + sefcik)
